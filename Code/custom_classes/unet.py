...
class UNET2D(model_config):
    """
        Keras 2D implementation of the U-Net architecture (U-Net2);
        Residual connections added between consecutive layers
    """
    def __init__(self, panel_sizes, model_arch=None, drop_rate=0.25, **kwargs):
        ...
        @params:
            ...
            model_arch  : other model architecture parameters
