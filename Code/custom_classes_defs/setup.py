...
class model_config(keras.Model):
    """ 
    Define common parameters & methods required for training a DL/CNN model;
    other parameters for the image processing are also  defined here 
    """
    def __init__(
            self, 
            optimizer='adam', 
    ...
    def info(self, prettyprint=True):
        """ Collects relevant model information """
    ...
    def execute_training(self, 
        ...
        """ Executes model training, vizualization and storage """
...
class f1_score(keras.metrics.Metric):
  ...
  def __init__(self, threshold=0.5, positive_label=1, name='f1_score', **kwargs):
    """ Custom definition of the F1-score suitable for a two-class classification tasks """
